...
if __name__ == '__main__':
    total_report = True
    all_data = load_data()
    # update_data('20200728', XZ=, YY=, HTP=, TP=, Zack=, XJ=, Yi=, HY=, Denn=, Daxia=, Man=, Six=)
    update_data('20200728', XZ=111, HTP=374, TP=-200, Zack=-44, XJ=305, Yi=-93, Denn=-600, Daxia=-780, Man=251, Six=676)
    generate_reports()
    clear_folder()

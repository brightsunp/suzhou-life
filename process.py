...
if __name__ == '__main__':
    total_report = True
    all_data = load_data()
    update_data('20200726', XZ=77-300-200, YY=-200, HTP=343-200, TP=300-200-442, Zack=-271, XJ=400, Yi=245, HY=166, Denn=800-300-800, Daxia=900-426, Man=-300-200-200, Six=1308-300-200)
    generate_reports()
    clear_folder()
